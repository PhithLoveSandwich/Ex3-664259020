...
const Pro3 = new Product_1.Product("P003", "Eraser", "BTS");
const Pro4 = new Product_1.Product("P004", "Notebook", "BTS");
...
const cart1 = new ShoppingCart_1.ShoppingCart("C001");
...
console.log("#################################################################");
console.log();
const cart2 = new ShoppingCart_1.ShoppingCart("C002");
...
console.log("#################################################################");
const payment1 = new Payment_1.Payment("PAY001", cart1.calculateTotal(), "2025-01-19", "Credit Card");
console.log("############################ Payment 1 ############################");
console.log(payment1.toString());
console.log("#################################################################");
const payment2 = new Payment_1.Payment("PAY002", cart2.calculateTotal(), "2025-01-20", "Credit Card");
